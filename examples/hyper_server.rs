...
use qiniu_multipart::mock::StdoutTee;
use qiniu_multipart::server::hyper::{HyperRequest, MultipartHandler, Switch};
use qiniu_multipart::server::{Entries, Multipart, SaveResult};
use std::io;
